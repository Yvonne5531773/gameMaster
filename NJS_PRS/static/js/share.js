(function() {
	var wxapi = "//res.wx.qq.com/open/js/jweixin-1.0.0.js", qqapi = "//open.mobile.qq.com/sdk/qqapi.js?_bid=152",
		...
		function doQQShare() {
			try {
				if (data.callback) {
					...
					window.mqq.data.setShareInfo(info, function(res) {
						// console.log('setShareInfo res', res)
					});
				}
			} catch (e) {
				console.log('_initQQ error:', e)
			}
		}
